package com.github.dinbtechit.ngxs.diagostic
...
class MyErrorReportSubmitter: ErrorReportSubmitter() {
    ...
    private fun getReportBody(events: Array<out IdeaLoggingEvent>, additionalInfo: String?): String {
        ...
        val plugin = PluginManagerCore.getPlugin(PluginId.getId("com.github.dinbtechit.ngxs"))
    ...
    private fun getReportIssueUrl(title: String, body: String): URI? {
        val uriBuilder = URIBuilder("https://github.com/dinbtechit/ngxs/issues/new")
